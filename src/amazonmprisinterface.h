#ifndef AMAZONMPRISINTERFACE_H
#define AMAZONMPRISINTERFACE_H
...
class AmazonMprisInterface : public MprisInterface {
  Q_OBJECT

public:
  explicit AmazonMprisInterface(QWidget *parent = nullptr);
